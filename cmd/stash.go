...
// `,
// 	RunE: func(cmd *cobra.Command, args []string) error {
// 		ms, err := OFDL.Ent.Subscription.Query().Where(subscription.OrganizedAtIsNil()).Limit(100).All(cmd.Context())
// 		if err != nil {
// 			return err
// 		}
//
...
// 		}
//
// 		mms, err := OFDL.Ent.MessageMedia.Query().
